...
- 状态：Run 聚合、多个 Operation、独立 Review、paused、Asset、Workspace/Map tombstone 和 Lease 的写入点已核对。
...
| TECH-04 | P1 | 059 已替换单 Claim/单 Operation 合同 | 已按当前工作树快照重写 scope/until、parse/split/verify、暂停恢复、迁移及客户端语义 |
