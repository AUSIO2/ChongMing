...
export function ctxFormat(ctx: Record<string, string>): string {
 ...
 */
export function ctxReadNews(raw: unknown): NewsContext {
...
export function ctxReadNewsDoc(doc: { context?: unknown }): NewsContext {
  return ctxReadNews(doc.context)
}
